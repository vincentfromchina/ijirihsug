...
public class ItemListFragment extends ListFragment
{
	...
	String[] list_meun = {"abc","bcd","dsaf","gsaf","gsadf"};
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		//setListAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_activated_1, android.R.id.text1, list_meun));
	}
	...
	public void onListItemClick(ListView listView, View view, int position, long id)
	{
		...
		//mCallbacks.onItemSelected("maji");
	}
